...
public class BcCTSBlockCipherTestFile {
    ...
    public static void test1() {
        ...
        // Wrap the block cipher with CTSBlockCipher
        CTSBlockCipher ctsCipher = new CTSBlockCipher(cipher); // Noncompliant {{(BlockCipher) AES-CTS}}

        // Initialize the CTSBlockCipher with the parameters
