...
public class JcaBaseAlgorithmMapperTest {
    ...
    void base() {
        ...
        Optional<Algorithm> algorithmOptional =
                algorithmMapper.parse(
                        "DiffieHellman", testDetectionLocation, Configuration.DEFAULT);
    ...
    void configuration() {
        ...
        JcaBaseAlgorithmMapper algorithmMapper = new JcaBaseAlgorithmMapper();
        Optional<Algorithm> algorithmOptional =
                algorithmMapper.parse("DiffieHellman", testDetectionLocation, new TestConfig());
