...
public class CryptographyMultiFernetTest extends TestBase {
    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/fernet/CryptographyMultiFernetTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(stores.size()).isEqualTo(2); //  ENCRYPT and DECRYPT
        ...
        // Encrypt under Algorithm under PrivateKey
        INode privateKeyEncryptNode = privateKeyAlgorithmNode.getChildren().get(Encrypt.class);
        assertThat(privateKeyEncryptNode).isNotNull();
        assertThat(privateKeyEncryptNode.asString()).isEqualTo("ENCRYPT");
