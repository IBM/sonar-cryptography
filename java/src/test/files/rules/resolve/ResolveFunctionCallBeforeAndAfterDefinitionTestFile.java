...
public class ResolveFunctionCallBeforeAndAfterDefinitionTestFile {
    ...
    public void genCipherBeforeDefinitionTest() {
        Cipher c = genCipher("RSA/ECB/PKCS1Padding", Cipher.ENCRYPT_MODE); // Noncompliant {{RSA/ECB/PKCS1Padding}}
    }
    ...
    public void genCipherAfterDefinitionTest() {
        Cipher c = genCipher("AES/ECB/PKCS5Padding", Cipher.DECRYPT_MODE); // Noncompliant {{AES/ECB/PKCS5Padding}}
    }
