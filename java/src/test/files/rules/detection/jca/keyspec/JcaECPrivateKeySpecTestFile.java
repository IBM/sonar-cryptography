...
public class JcaECPrivateKeySpecTestFile {
    ...
    public void base() {
        Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding"); // Noncompliant {{AES/ECB/PKCS5Padding}}
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("EC"); // Noncompliant {{EC}}
