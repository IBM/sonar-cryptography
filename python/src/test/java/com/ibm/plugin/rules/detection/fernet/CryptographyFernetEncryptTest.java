...
public class CryptographyFernetEncryptTest extends TestBase {
    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/fernet/CryptographyFernetEncryptTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(stores.size()).isEqualTo(1); //  ENCRYPT
