...
class BcGenericSignerTest extends TestBase {
    ...
    public void asserts(
        ...
        /**
         * Optimally, we shouldn't have direct detections of engines, as they appear in the
        ...
        if (findingId == 1) {
            ...
            assertThat(oidNode1.asString()).isEqualTo("1.2.840.113549.1.1.11");
            ...
            IValue<Tree> value0_2 = store_2.getDetectionValues().get(0);
            assertThat(value0_2).isInstanceOf(ValueAction.class);
            assertThat(value0_2.asString()).isEqualTo("PKCS1Encoding");
            ...
            assertThat(value0_2_1.asString()).isEqualTo("ElGamalEngine");
            ...
            assertThat(signatureNode.getKind()).isEqualTo(Signature.class);
            assertThat(signatureNode.getChildren()).hasSize(3);
            assertThat(signatureNode.asString()).isEqualTo("ElGamal");
