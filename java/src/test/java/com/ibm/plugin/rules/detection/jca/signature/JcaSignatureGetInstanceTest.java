...
class JcaSignatureGetInstanceTest extends TestBase {
    ...
    /**
     * DEBUG [detectionStore] (SignatureContext, Algorithm) SHA384withDSA DEBUG [translation]
     * (Signature) SHA384withDSA DEBUG [translation] └─ (MessageDigest) SHA-384 DEBUG [translation]
     * └─ (KeyLength) 384 DEBUG [translation] └─ (DigestSize) 384 DEBUG [translation] └─ (BlockSize)
     * 1024 DEBUG [translation] └─ (Algorithm) DSA
     */
    @Override
    public void asserts(
            int findingId,
