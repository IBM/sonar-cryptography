...
public class CryptographyGenerateTest extends TestBase {
    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/asymmetric/CryptographyGenerateTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        String curve = findingId > 1 ? "Curve448" : "Curve25519";
        ...
        assertThat(publicKeyNode)
                .isInstanceOfAny(
                        PublicKey.class,
                        Key.class); // This is because .deepCopy creates a new Key object (and
        // not a PublicKey)
