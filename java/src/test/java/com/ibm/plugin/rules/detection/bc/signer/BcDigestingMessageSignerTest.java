...
class BcDigestingMessageSignerTest extends TestBase {
    ...
    public void asserts(
        ...
        assertThat(value0_2.asString()).isEqualTo("SPHINCS256Signer");
        ...
        assertThat(value0_2_2.asString()).isEqualTo("SHAKEDigest");
        ...
        assertThat(mergeableCollectionNode.getChildren()).isEmpty();
